...
def main():
    ...
    for claim in claims:
        ...
        for rank, candidate in enumerate(ranked, 1):
            ...
            out.append({
                ...
                "scope_gate_code": norm_claim.get("scope_gate_code", ""),
                "scope_gate_reason": norm_claim.get("scope_gate_reason", ""),
                "scope_gate_severity": norm_claim.get("scope_gate_severity", ""),
                "candidate_rank": rank,
                "candidate_rank": rank,
    ...
    fields = [
        ...
        "value_type", "measurement_role", "measurement_usage", "period", "prd_se", "change_base", "comparison_period","value", "unit", "raw_unit", "unit_dimension", "semantic_type", "entity_type",
        "value_type", "measurement_role", "measurement_usage", "period", "prd_se", "change_base", "comparison_period",
        "scope_gate_code", "scope_gate_reason", "scope_gate_severity",
