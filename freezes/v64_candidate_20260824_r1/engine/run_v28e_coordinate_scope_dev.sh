...
BASE=$PROJECT/runs/v28d_axis_table_opened30_dev_20260820
OUT=$PROJECT/runs/v28e_coordinate_scope_opened30_dev_20260820
...
cp "$BASE"/stage_b_coordinate_beam.jsonl "$OUT"/
...
echo V28E_COORDINATE_SCOPE_OPENED30_DEV_COMPLETE
