...
> 보관 문서: 실전1 당시의 경로와 결과를 기록한다. 문서에 적힌
> `outputs/bteam_*` CSV·XLSX는 현재 브랜치에서 제거됐으며 Git 과거 커밋에서
> 복구할 수 있다. 현행 구조는 `docs/file_structure.md`를 따른다.
...
실전1 제출 기준:
- KOSIS 통계표 인덱스 최신본: `data/reference/kosis_table_summary.csv` 107,138건
...
- `data/reference/kosis_table_summary.csv`
  - KOSIS 통계표 목록
- `data/reference/kosis_metadata_summary.csv`
