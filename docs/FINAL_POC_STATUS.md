...
조선일보 기사 URL에서 수치 주장을 찾아 KOSIS 공식 좌표와 값을 대조하는 전체 서비스 흐름은 연결됐고, v60은 개발 300건 검색·좌표 목표를 통과한 발표·서비스 후보입니다. 다만 독립 데이터 일반화와 자동 검증 커버리지는 후속 과제입니다.
...
2. 조선일보 원본 URL E2E 고정 표본 최종 감사
3. 자동 검증 커버리지 개선과 실패 유형별 QA
4. 프론트 최종 디자인·결과 설명·예외 메시지 통합
