...
def rerank_coordinate_record(
    ...
    for row, score in zip(rows, scores):
        ...
        item_exact_bonus = DEFAULT_ITEM_EXACT_BONUS if item_exact_match else 0.0
        row.update({
            ...
            "item_exact_bonus": item_exact_bonus,
            "final_rank_score": (
                candidate["final_rank_score"] + applied_obj_bonus + item_exact_bonus
            ),
        })
