...
**커버리지 (잠근 103건, `report_coverage.py`)**

| | 건수 | |
|---|---|---|
| 확정 | 12 (12%) | READY 또는 PROVISIONAL |
| 확인 불가 | 33 (32%) | 기간이 기사일 이후 15 · 좌표는 맞고 데이터 없음 12 · 기간 불명 6 |
| 시스템 한계 | 58 (56%) | 후보 비결정 24 · 단위 확인 불가 22 · 좌표 오류 12 |

- **전체 기준 11.7%** — 사용자가 기사를 넣었을 때 실제로 답을 받을 확률
- **확인 가능 기준 17.1%** — 답할 수 있는 문제에서 시스템이 얼마나 하는가
