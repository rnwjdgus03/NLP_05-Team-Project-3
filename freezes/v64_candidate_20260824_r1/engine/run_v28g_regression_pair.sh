...
exec > >(tee -a "$PROJECT/runs/v28g_regression_pair_20260820.log") 2>&1
...
run_set \
  ...
  "$PROJECT/runs/v28g_previous30_regression_20260820"

run_set \
  "$PROJECT/blind/v25/locked300_v14_mcp_blind30_candidates.csv" \
  "$PROJECT/blind/v25/v25_blind_coordinate_gold10_locked.csv" \
  "$PROJECT/runs/v28g_old10_regression_20260820"

echo V28G_REGRESSION_PAIR_COMPLETE
