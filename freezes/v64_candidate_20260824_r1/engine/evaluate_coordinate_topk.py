...
def main() -> None:
    ...
    prediction_overlap = sum(
        text(row.get("claim_measurement_id")) in packets for row in eligible
    )
    ...
    summary = {
        "schema_version": "kosis-coordinate-topk-eval-v2",
        ...
        "missing_prediction_packets": len(eligible) - prediction_overlap,
        "ks": ks,
