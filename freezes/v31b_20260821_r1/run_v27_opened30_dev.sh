...
OUT=$PROJECT/runs/v27_opened_official30_dev_20260820
...
sha256sum "$OUT"/stage_a_table_recall_summary.json \
  "$OUT"/coordinate_topk_summary.json "$OUT"/verified_candidates.jsonl \
  "$OUT"/claim_decisions.jsonl > "$OUT/final_outputs_sha256.txt"
echo V27_OPENED_OFFICIAL30_DEV_COMPLETE
