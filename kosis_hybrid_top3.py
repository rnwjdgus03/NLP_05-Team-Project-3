...
def lexical_query_document(claim: Mapping[str, Any]) -> str:
    ...
    weighted = [indicator, indicator, domain, domain]
    weighted.extend(
...
def semantic_query_document(claim: Mapping[str, Any]) -> str:
    ...
    fields = (
        ("통계영역", _first_query_value(claim, "metric_domain")),
        ...
        ("핵심어", _first_query_value(claim, "keywords")),
        ("기사제목", _first_query_value(claim, "title")),
