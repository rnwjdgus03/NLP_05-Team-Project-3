...
EXPECTED_FREEZE_ID = os.getenv(
    "KOSIS_EXPECTED_FREEZE_ID", "v42_service_20260823_r1"
)
EXPECTED_CODE_SHA256 = os.getenv(
    "KOSIS_EXPECTED_CODE_SHA256",
    "d4fb3c698626c0c098a1d2c383199a39423886f7e4e72654bb4cc74c5cb28594",
)
...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            engine_dir=Path(os.getenv(
                "KOSIS_ENGINE_DIR",
                str(root / "freezes" / "v42_service_20260823_r1"),
            )),
            ...
            runs_dir=Path(os.getenv("KOSIS_SERVICE_RUNS_DIR", str(root / "runs" / "service_v42"))),
    ...
    def validate_engine(self) -> dict:
        ...
        if not manifest_path.is_file():
            raise RuntimeError(f"v42 freeze manifest not found: {manifest_path}")
        ...
        if manifest.get("code_tree_sha256") != EXPECTED_CODE_SHA256:
            raise RuntimeError("unexpected v42 code SHA")
        required = (
